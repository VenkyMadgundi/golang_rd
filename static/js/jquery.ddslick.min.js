                ...
                $.each(options.data, function (index, item) {
                    ddOptions.append('<li>' +
                        '<a ' + (item.href === undefined ? '' : 'href="' + item.href + '" target="' + item.target + '"') + ' class="dd-option">' +
                            ...
                            (item.text ? ' <span class="dd-option-text" style="cursor:pointer;">' + item.text + '</span>' : '') +
        ...
        if (ddSelected.text().length == 0 || !settings.resetmenu) {
            if (settings.showSelectedHTML) {
                ddSelected.html(
                        ...
                        (selectedData.text ? '<span class="dd-selected-text" style="cursor:pointer;">' + selectedData.text + '</span>' : '') +
