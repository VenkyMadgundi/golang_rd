...
var FacebookList = Class.create(TextboxList, { 
  ...
  onAddCallback: function(item) {},
  onRemoveCallback: function(item) {}
...
Element.addMethods({
    onBoxDispose: function(item,obj) { 
        ...
        obj.onRemoveCallback(item);
        if(obj.options.get('onRemoveCallback'))
            obj.options.get('onRemoveCallback').call(obj, item)
    },
