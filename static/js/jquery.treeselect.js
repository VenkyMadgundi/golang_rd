...
(function($) {
  ...
  $.fn.treeselect = function(params) {
    ...
    params = $.extend({
      ...
      selected: true,             /** Callback when an item is selected. */
      ...
      inputType: 'checkbox'       /** Select input type from checkbox / radio. */
    }, params);
...
(function($) {
  ...
  $.fn.chosentree = function(params) {
    ...
    params = $.extend({
      inputId: 'choice',     /** The input element ID and NAME. */
      ...
      autosearch: true,                /** If we would like to autosearch. */
